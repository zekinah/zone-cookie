...
class Zone_Cookie_Model_Config
{
    ...
    public function createTable()
    {
        ...
        $ccpa_content = "<h2><strong>CCPA Compliance</strong></h2> 
            ...
            <p>This Privacy Notice for California Residents supplements the information contained in WEBSITE’s <a href='/privacy-policy/'>Privacy Policy</a> and applies solely to all visitors, users, and others who reside in the State of California (“consumers” or “you”). We adopt this notice to comply with the California Consumer Privacy Act of 2018 (CCPA) and any terms defined in the CCPA have the same meaning when used in this notice.</p>
            <p><strong>INFORMATION WE COLLECT</strong></p>
            <p>The www.primeview.com website (the “Site”) collects information that identifies, relates to, describes, references, is capable of being associated with, or could reasonably be linked, directly or indirectly, with a particular consumer or device (“personal information”). In particular, the Site has collected the following categories of personal information from its consumers within the last 12 months:</p>
            <table>
            <thead>
                <tr>
                    <th>Category</th>
